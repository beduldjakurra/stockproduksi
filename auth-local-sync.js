...
(function () {
  ...
  function createPanel() {
    ...
    Object.assign($export.style, { width: "100%", marginTop: "6px", padding: "8px", border: "1px solid #dee2e6", borderRadius: "8px", cursor: "pointer", background: "white", color: "#2b2d42", fontWeight: "600" });
